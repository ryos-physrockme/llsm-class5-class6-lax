...
\fancyhead[R]{\small 2026年9月15日}\fancyfoot[C]{\thepage}
...
\input{parts/01_history.tex}
\input{parts/02_ml_search.tex}
\input{parts/03_common_math.tex}
\input{parts/04_class5.tex}
\input{parts/05_class6.tex}
\input{parts/06_common_correction.tex}
\input{parts/07_research_branches.tex}
\input{parts/08a_audit_class5_quantum.tex}
\input{parts/08b_audit_class6_quantum.tex}
\input{parts/08c_audit_class5_rmatrix.tex}
\input{parts/10_shared_site_generalization.tex}
\input{parts/11_class6_eleven_vertex_comparison.tex}
\input{parts/12_class5_generic_lax_comparison.tex}
\input{parts/12b_class5_hamiltonian_comparison.tex}
\input{parts/09_index.tex}
