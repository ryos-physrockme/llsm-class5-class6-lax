...
検証プログラム\texttt{scripts/class6/verify\_eleven\_vertex\_comparison.py}は、式\eqref{eq:class6-eleven-U-map}、式\eqref{eq:class6-eleven-V-map}、運動方程式、および零曲率規約の変換係数を記号計算で独立に確認する。比較では$S^+,S^-,S^3$と一階・二階空間微分を独立な記号として扱い、最終行列の成分一致に運動方程式を代入していない。
