...
$\widehat{\mathcal D}^{(\pm)}_{5;a,n}$.  Substituting
Eqs.~\eqref{eq:class5-A-expansion} and \eqref{eq:class5-L-expansion} into
...
\end{equation}
We write $V_5(x,t;\lambda)=\bigl((V_5)_{rs}\bigr)_{r,s=1}^{2}$ and
$S_x^a:=\partial_x S^a$ for $a\in\{+,-,3\}$.  Substituting
