...
\end{equation}
The scalar sector is therefore locally flat on the Class 5 equations of
motion.  The full $\mathfrak{gl}(2)$ pair agrees with the traceless pair only
locally on shell, after a scalar auxiliary transformation.
