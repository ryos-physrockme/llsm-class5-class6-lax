...
Ref.~\cite{KameyamaYoshida2014}.  Thus the comparison of Lax pairs below is
between two representations of the same local complexified classical
dynamics.  The real sections remain different.
