...
+\alpha M_5\partial_x\boldsymbol S
\right).
...
We finally test the relation between the corrected Lax pair and the equations
of motion without imposing the equations of motion in the curvature.  Define
...
\eqref{eq:class5-spatial-Lax} and \eqref{eq:class5-time-Lax-final} is
\begin{equation}
F^{(5)}_{tx}
:=
...
\frac{1}{4\lambda}
\begin{pmatrix}
E_3+2\alpha\lambda E_+
&
E_- -2\alpha\lambda E_3\\
E_+
&
-E_3
\end{pmatrix}.
...
\begin{equation}
E_+=4\lambda F^{(5)}_{21},
\qquad
E_3=-4\lambda F^{(5)}_{22},
\qquad
E_-=4\lambda\left(
F^{(5)}_{12}-2\alpha\lambda F^{(5)}_{22}
\right).
